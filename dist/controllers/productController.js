...
import { enqueueAdminProductAdded, enqueueAdminProductUpdated, enqueueAdminLowStockAlert, enqueueAdminOutOfStockAlert, enqueueAdminUserActivity, // summary activity for bulk ops
...
const getTopSellingProducts = asyncHandler(async (_req, res) => {
...
const bulkUpdateProducts = asyncHandler(async (req, res) => {
    ...
    const update = {};
    if (category)
        update.category = new mongoose.Types.ObjectId(category);
    if (status)

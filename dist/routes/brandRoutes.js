...
import { getBrands, getBrandById, createBrand, updateBrand, deleteBrand, getBrandProducts, getBrandStats, bulkUpdateBrands, getActiveBrands } from '../controllers/brandController.js';
const router = Router();
// Public routes
